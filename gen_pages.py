...
SVG_CHECK = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>'
SVG_CODE  = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>'
SVG_LINK  = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>'
SVG_BACK  = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>'
SVG_UP    = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/></svg>'

def page(p):
    feat = "\n".join(f'<li>{SVG_CHECK}<span>{f}</span></li>' for f in p["features"])
    tech = "\n".join(f'<li>{SVG_CODE}<span>{t}</span></li>' for t in p["techStackDetails"])
    pills = "".join(f'<span class="tech-pill">{t}</span>' for t in p["tech"])
    return f"""<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{p['name']} &mdash; ThemeMint</title>
    ...
    <nav id="navbar">
        <div class="container">
            <div class="nav-content">
                <a href="../index.html" class="logo"><img src="../Logo.png" alt="ThemeMint Logo"></a>
                <ul class="nav-links">
        ...
        <div class="container">
            <div class="detail-header-inner">
                ...
                <div class="detail-header-actions" data-reveal>
                    <a href="{p['link']}" target="_blank" class="btn btn-primary">{SVG_LINK} Live Preview</a>
                    <a href="../index.html#portfolio" class="btn btn-secondary">{SVG_BACK} Back to Portfolio</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer id="contact">
        <div class="container">
            <div class="footer-content">
                <div class="footer-logo"><img src="../Logo.png" alt="ThemeMint Logo"></div>
                <div class="footer-links">
                    <a href="#">Twitter</a><a href="#">LinkedIn</a>
                    <a href="#">Instagram</a><a href="#">Dribbble</a>
                </div>
...
projects = [
    {
        ...
        "name": "Bite Haven",
        "category": "Food",
        "tagline": "Bold Flavors. Fast Service. Better Experience",
        "shortDesc": "High-impact fast food restaurant landing page for menus and orders.",
        "description": "Bite Haven is a high-impact fast food restaurant landing page crafted to showcase menu offerings, promotions, and brand personality in a visually engaging way. The platform focuses on appetizing visuals, clear navigation, and strong call-to-action placement to drive online orders and customer engagement. Designed with bold colors and modern typography, Bite Haven creates an instant craving-driven connection with users. The layout highlights best-selling items, categories, and special deals while maintaining a smooth and enjoyable browsing experience. It is built to help restaurants increase conversions and strengthen their digital presence.",
    ...
    },
    {
        ...
        "name": "Shop Ease",
        "category": "E-commerce",
        "tagline": "Simple Shopping, Smarter Sales",
    ...
    {
        "slug": "next-gen-agency",
        "name": "Next Gen Agency",
        "category": "Agency",
    ...
    {
        "slug": "thememint-launch-kit",
        "name": "ThemeMint Launch Kit",
        "category": "SaaS",
    ...
    },
    {
        ...
        "audience": "Food lovers, cafe visitors, restaurant owners, and modern dining brands.",
        "tech": ["HTML5","CSS3","JavaScript","Responsive Design","Performance Optimized"],
    ...
    },
    {
        ...
        "name": "Veloura Bakery",
        "category": "Food",
        "tagline": "Crafted with Love. Baked to Perfection",
        "shortDesc": "Soft, elegant bakery landing page designed to showcase handcrafted baked goods.",
        "description": "Veloura Bakery is a soft, elegant bakery landing page designed to showcase handcrafted baked goods in a warm and inviting way. The design emphasizes pastel tones, smooth spacing, and mouth-watering product visuals to create a comforting user experience. From fresh breads to luxury desserts, the layout guides visitors through products effortlessly while highlighting quality, freshness, and craftsmanship.",
        ...
        "audience": "Bakery customers, dessert lovers, cafe brands, and small food businesses.",
    ...
    },
    {
        ...
        "name": "Cafe Ember",
        "category": "Food",
        "tagline": "Warm Moments. Perfect Brews",
        "shortDesc": "Cozy and modern cafe landing page built to reflect warmth, comfort, and lifestyle appeal.",
        "description": "Cafe Ember is a cozy and modern cafe landing page built to reflect warmth, comfort, and lifestyle appeal. The design uses earthy tones, minimal layouts, and atmospheric imagery to create an inviting digital cafe experience. It highlights beverages, snacks, and cafe ambiance while encouraging visitors to relax, explore, and visit in person.",
        "problem": "Many cafe websites lack emotional connection and atmosphere, failing to represent the in-store experience online.",
        "solution": "Cafe Ember recreates the cafe's cozy vibe digitally through thoughtful design, smooth navigation, and visually rich sections that engage users instantly.",
        "features": ["Cozy, lifestyle-focused visual design","Strong hero section with brand messaging","Highlighted drinks and cafe specials","Smooth scrolling and minimal navigation","Atmosphere-driven color scheme"],
        ...
        "audience": "Coffee lovers, cafe visitors, lifestyle brands, and boutique cafes.",
...
for p in projects:
    html = page(p)
    out = os.path.join(BASE, p["slug"] + ".html")
    with open(out, "w", encoding="utf-8") as f:
        f.write(html)
    print(f"Created: {out}")

print(f"\nAll {len(projects)} pages generated!")
